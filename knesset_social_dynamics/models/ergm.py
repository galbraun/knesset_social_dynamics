...
# Taken from https://computational-communication.com/ergm-python/
# https://github.com/jcatw/ergm/blob/master/ergm.py
# https://gist.github.com/dmasad/8509304
...
def fit_ergm(G, coeff_samples=100, graph_samples=1000, return_all=False):
    ...
    with tqdm(total=coeff_samples) as pbar:
